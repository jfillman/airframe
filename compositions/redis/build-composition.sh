...
#
# First real Component XRD's Composition - Item 7 Sequencing step 3
# (service-catalog-design.md). Single function-go-templating step: renders
# a provider-helm Release wrapping Bitnami's own redis chart - see
# templates/release.yaml's own header for the full mapping/reasoning.
#
