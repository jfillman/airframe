...
#
# Renders the provider-infisical resource chain (project, environments, machine identity
# and auth config, membership) and an ESO ClusterSecretStore pointed at the credentials
# that chain produces - idp/docs/service-catalog-design.md Item 8. (Until 2026-09-23 this
# was an InfisicalProject CR reconciled by the infisical-secretstore-operator, now retired.) NOT yet wired into
